...
import { OTPInputContainer, SplitOTPBoxesContainer, TextInputHidden, SplitBoxes, SplitBoxText, SplitBoxesFocused } from "./styles";
...
const OTPInput = ({ code, setCode, maximumLength, setIsPinReady }) => {
	...
	return (
		<OTPInputContainer>
			...
			<TextInputHidden value={code} onChangeText={setCode} maxLength={maximumLength} ref={inputRef} onBlur={handleOnBlur} />
		</OTPInputContainer>
	);
};
